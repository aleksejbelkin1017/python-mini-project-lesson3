...
@pytest.fixture
def transactions_to_filter_by_currency_in():
...
@pytest.fixture
def transactions_to_filter_by_currency_out_for_rub():
    return (
        {'id': 873106923,
         'state': 'EXECUTED',
         'date': '2019-03-23T01:09:46.296404',
...
@pytest.fixture
def transactions_to_filter_by_currency_out_for_usd():
    return (
        {'id': 939719570,
         'state': 'EXECUTED',
         'date': '2018-06-30T02:08:58.425572',
...
@pytest.fixture
def transactions_to_transaction_descriptions_without_any_description():
    """Пример входных данных. Для проверки функций filter_by_currency и transaction_descriptions"""
    return (
        [
            {
